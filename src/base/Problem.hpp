...
public:
    ...
    virtual double evaluate_constraint(int j, const std::vector<double>& x) const = 0;
    virtual std::vector<double> evaluate_constraints(const std::vector<double>& x) const = 0;
