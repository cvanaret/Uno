...
class GlobalizationStrategy {
    public:
        ...
        virtual Iterate initialize(Problem& problem, std::vector<double>& x, std::vector<double>& bound_multipliers, std::vector<double>& constraint_multipliers, bool use_trust_region) = 0;
