...
extern "C" {
    ...
    void ma57ad_(int* n, int* ne, const int irn[], const int jcn[], int* lkeep, int keep[], int iwork[], int icntl[], int info[], double rinfo[]);
    // numerical factorization
    void ma57bd_(int* n, int* ne, const double a[], /* out */ double fact[], const int* lfact, /* out */ int ifact[], const int* lifact, const int* lkeep, const int keep[], int iwork[], int icntl[], double cntl[], /* out */ int info[], /* out */ double rinfo[]);
    // linear system solve
...
void MA57Solver::do_numerical_factorization(const COOMatrix& matrix) {
    ...
    ma57bd_(&this->factorization_.n,
            ...
            /* const */ this->factorization_.keep.data(),
            this->factorization_.iwork.data(),
            this->icntl_.data(),
            this->cntl_.data(),
...
void MA57Solver::solve(std::vector<double>& rhs) {
    ...
    ma57cd_(&job,
            &n,
            this->factorization_.fact.data(),
            &this->factorization_.lfact,
            this->factorization_.ifact.data(),
            &this->factorization_.lifact,
            &nrhs,
            rhs.data(),
            &lrhs,
            work.data(),
