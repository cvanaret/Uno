...
!                                        
!
!                      DRIVERSL1 in Fortran 90 (Sven's 1st Problem)
!     --------------------------------------------------------------
!
...
!     We now define the starting point.
  ...
  16  format(/,5x, 'Solving sample problem.', &
             /,5x, ' (f = 1.0 at the optimal solution.)',/)               
...
!     end of loop do while
      ...
      write (6,*) 'Final L-BFGS-B Solution'
      write (6,*) 'lower bound   x-value      upper bound  gradient'
      RedGrad = 0.0d0
      do i=1,n
         write (6,'(1x,4(d11.4,2x))') l(i),x(i),u(i),g(i)
         RedGrad = RedGrad + abs( min( x(i)-l(i) , u(i)-x(i) )*g(i) )
      end do
      write (6,*) 'Reduced Gradient Norm = ', RedGrad
