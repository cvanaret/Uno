...
pub fn get_version() -> (i32, i32, i32) {
    let mut major: uno_int = 0;
    let mut minor: uno_int = 0;
    let mut patch: uno_int = 0;
...
impl Model {
    ...
    pub fn set_objective(
        &mut self,
        sense: uno_int,
        objective_fn: uno_objective_callback,
        gradient_fn: uno_objective_gradient_callback,
    ) -> bool {
    ...
    pub fn set_constraints(
        &mut self,
        constraint_fn: uno_constraints_callback,
        lower_bounds: &[f64],
        upper_bounds: &[f64],
        jacobian_row_indices: &[uno_int],
        jacobian_col_indices: &[uno_int],
        jacobian_fn: uno_constraints_jacobian_callback,
    ) -> bool {
    ...
    pub fn set_jacobian_operator(&mut self, op: uno_constraints_jacobian_operator_callback) -> bool {
        unsafe { ffi::uno_set_jacobian_operator(self.ptr, op) }
    }

    pub fn set_jacobian_transposed_operator(
        &mut self,
        op: uno_constraints_jacobian_transposed_operator_callback,
    ) -> bool {
    ...
    pub fn set_lagrangian_hessian(
        ...
        row_indices: &[uno_int],
        col_indices: &[uno_int],
        hessian_fn: uno_lagrangian_hessian_callback,
    ) -> bool {
    ...
    pub fn set_lagrangian_hessian_operator(
        &mut self,
        op: uno_lagrangian_hessian_operator_callback,
    ) -> bool {
        unsafe { ffi::uno_set_lagrangian_hessian_operator(self.ptr, op) }
    }

    pub fn set_lagrangian_sign_convention(&mut self, convention: uno_int) -> bool {
    ...
    pub fn set_initial_primal_component(&mut self, index: uno_int, value: f64) -> bool {
        unsafe { ffi::uno_set_initial_primal_iterate_component(self.ptr, index, value) }
    }

    pub fn set_initial_dual_component(&mut self, index: uno_int, value: f64) -> bool {
...
pub struct Solution {
    pub optimization_status: uno_int,
    pub solution_status: uno_int,
    pub objective: f64,
    pub primals: Vec<f64>,
...
impl Solver {
    ...
    pub fn set_integer_option(&self, name: &str, value: uno_int) -> bool {
    ...
    pub fn set_callbacks(
        &self,
        notify_cb: Option<uno_notify_acceptable_iterate_callback>,
        termination_cb: Option<uno_termination_callback>,
        user_data: *mut c_void,
    ) -> bool {
