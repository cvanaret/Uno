...
function gen_get_string_option_fortran_wrapper(io)
  ...
  println(io, "   if (.not. c_associated(ptr_solver_string_option_c)) then")
  println(io, "      solver_string_option = \"\"")
  println(io, "      return")
  println(io, "   endif")
  println(io, "   call c_f_pointer(ptr_solver_string_option_c, solver_string_option_c, [1])")
  println(io, "   n = 1")
  println(io, "   do while (solver_string_option_c(n) /= c_null_char)")
  println(io, "      n = n + 1")
  println(io, "   end do")
  println(io, "   allocate(character(len=n-1)::solver_string_option)")
  println(io, "   do i = 1, n-1")
...
function gen_get_method_description_fortran_wrapper(io)
  ...
  println(io, "   if (.not. c_associated(ptr_method_description_c)) then")
  println(io, "      method_description = \"\"")
  println(io, "      return")
  println(io, "   endif")
  println(io, "   call c_f_pointer(ptr_method_description_c, method_description_c, [1])")
  println(io, "   n = 1")
  println(io, "   do while (method_description_c(n) /= c_null_char)")
  println(io, "      n = n + 1")
  println(io, "   end do")
  println(io, "   allocate(character(len=n-1)::method_description)")
  println(io, "   do i = 1, n-1")
