...
function gen_get_string_option_fortran_wrapper(io)
  ...
  println(io, "      return")
  println(io, "   endif")
  println(io, "   call c_f_pointer(ptr_solver_string_option_c, solver_string_option_c, [huge(0)])")
  println(io, "   n = 0")
...
function gen_get_method_description_fortran_wrapper(io)
  ...
  println(io, "      return")
  println(io, "   endif")
  println(io, "   call c_f_pointer(ptr_method_description_c, method_description_c, [huge(0)])")
  println(io, "   n = 0")
