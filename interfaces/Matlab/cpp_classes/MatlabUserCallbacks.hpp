...
namespace uno {
    ...
    public:
        ...
        bool termination(const Vector<double>& primals, const Multipliers& multipliers, double objective_multiplier, double primal_feasibility, double stationarity, double complementarity) override;

    private:
        handle_t notify_acceptable_iterate_callback;
        handle_t termination_callback;
    };
