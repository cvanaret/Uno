...
# this script is parameterized by the linear solver passed as command line argument (e.g., runtests_uno_pure_sqp.jl MA57)
...
Optimizer_Uno_ipopt() = Optimizer(["logger=SILENT", "preset=ipopt", "hessian_model=LBFGS", "linear_solver=$linear_solver"])
