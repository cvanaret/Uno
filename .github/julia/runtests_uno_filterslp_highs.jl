...
Optimizer_Uno_filterslp() = Optimizer(["logger=SILENT", "preset=filterslp", "LP_solver=HiGHS", "max_iterations=10000",
                                       "unbounded_objective_threshold=-1e15", "dual_tolerance=1e-6"])
