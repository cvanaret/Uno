...
# this script is parameterized by the linear solver passed as command line argument (e.g., runtests_uno_ipopt_identity.jl MA57)
...
Optimizer_Uno_ipopt() = Optimizer(["logger=SILENT", "preset=ipopt", "linear_solver=$linear_solver", "hessian_model=identity", "unbounded_objective_threshold=-1e15"])
