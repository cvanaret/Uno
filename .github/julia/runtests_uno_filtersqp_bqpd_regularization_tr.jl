...
Optimizer_Uno_filtersqp() = Optimizer(["logger=SILENT", "preset=filtersqp", "QP_solver=BQPD", "regularization_strategy=primal", "max_iterations=10000", "unbounded_objective_threshold=-1e15"])
