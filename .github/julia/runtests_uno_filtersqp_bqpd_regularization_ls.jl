...
Optimizer_Uno_filtersqp() = Optimizer(["logger=INFO", "preset=filtersqp", "QP_solver=BQPD", "inertia_correction_strategy=primal", "globalization_mechanism=LS", "max_iterations=10000", "unbounded_objective_threshold=-1e15"])
