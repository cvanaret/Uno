...
Optimizer_Uno_filtersqp() = Optimizer(["logger=SILENT", "preset=filtersqp", "hessian_model=identity", "QP_solver=BQPD", "max_iterations=10000", "unbounded_objective_threshold=-1e15"])
