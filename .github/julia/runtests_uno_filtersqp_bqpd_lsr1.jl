...
Optimizer_Uno_filtersqp() = Optimizer(["logger=SILENT", "preset=filtersqp", "QP_solver=BQPD", "hessian_model=LSR1", "quasi_newton_memory_size=20", "max_iterations=10000", "unbounded_objective_threshold=-1e15"])
