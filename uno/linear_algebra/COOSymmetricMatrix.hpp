...
public:
   ...
   const IndexType* row_indices_pointer() const { return this->row_indices.data(); }
   IndexType* row_indices_pointer() { return this->row_indices.data(); }
   const IndexType* column_indices_pointer() const { return this->column_indices.data(); }
   IndexType* column_indices_pointer() { return this->column_indices.data(); }
...
template <typename IndexType, typename ElementType>
ElementType COOSymmetricMatrix<IndexType, ElementType>::smallest_diagonal_entry(size_t max_dimension) const {
