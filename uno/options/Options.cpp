...
namespace uno {
   const std::unordered_map<std::string, OptionType> Options::option_types = {
      ...
      {"subproblem_solver", OptionType::STRING},
      ...
      {"filter_switching_infeasibility_exponent", OptionType::DOUBLE},
      {"funnel_beta", OptionType::DOUBLE},
      {"funnel_gamma", OptionType::DOUBLE},
      {"mma_asyinit", OptionType::DOUBLE},
      {"mma_asyincr", OptionType::DOUBLE},
      {"mma_asydecr", OptionType::DOUBLE},
      {"mma_external_move_limit", OptionType::DOUBLE},
      {"mma_internal_limit", OptionType::DOUBLE},
      {"mma_max_inner_iterations", OptionType::INTEGER},
      {"funnel_gamma", OptionType::DOUBLE},
