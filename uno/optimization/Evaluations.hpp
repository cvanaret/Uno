...
namespace uno {
   ...
   public:
      ...
      void compute_jacobian_vector_product(const Model& model, View<const double> vector, View<double> result) const;
      void compute_jacobian_transposed_vector_product(const Model& model, View<const double> vector, View<double> result) const;
