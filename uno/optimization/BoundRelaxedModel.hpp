...
inline size_t BoundRelaxedModel::get_maximum_number_objective_gradient_nonzeros() const {
   return this->original_model->get_maximum_number_objective_gradient_nonzeros();
}

inline size_t BoundRelaxedModel::get_maximum_number_jacobian_nonzeros() const {
   return this->original_model->get_maximum_number_jacobian_nonzeros();
}

inline size_t BoundRelaxedModel::get_maximum_number_hessian_nonzeros() const {
