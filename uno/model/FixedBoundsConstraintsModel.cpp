...
namespace uno {
   ...
   void FixedBoundsConstraintsModel::compute_hessian_sparsity(View<uno_int> row_indices, View<uno_int> column_indices,
   ...
   void FixedBoundsConstraintsModel::postprocess_solution(Iterate& iterate, Evaluations& evaluations) const {
