...
namespace uno {
   ...
   protected:
      ...
      void solve_sequence_of_relaxed_subproblems(Statistics& statistics, InequalityHandlingMethod& inequality_handling_method, const Model& model,
         Iterate& current_iterate, Direction& direction, double trust_region_radius, WarmstartInformation& warmstart_information);
      void solve_l1_relaxed_problem(Statistics& statistics, InequalityHandlingMethod& inequality_handling_method, const Model& model,
         Iterate& current_iterate, Direction& direction, double current_penalty_parameter, double trust_region_radius,
      ...
      void enforce_linearized_residual_sufficient_decrease(Statistics& statistics, InequalityHandlingMethod& inequality_handling_method,
      ...
      void enforce_descent_direction_for_l1_merit(Statistics& statistics, InequalityHandlingMethod& inequality_handling_method,
         const Model& model, Iterate& current_iterate, Direction& direction, const Direction& feasibility_direction,
         double trust_region_radius, WarmstartInformation& warmstart_information);
      ...
      [[nodiscard]] ProgressMeasures compute_predicted_reductions(InequalityHandlingMethod& inequality_handling_method,
         const Model& model, Iterate& current_iterate, const Direction& direction, double step_length);
