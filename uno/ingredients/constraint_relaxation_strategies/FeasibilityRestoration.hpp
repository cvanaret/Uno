...
namespace uno {
   ...
   private:
      ...
      void switch_to_optimality_phase(Iterate& current_iterate, InequalityHandlingMethod& inequality_handling_method,
      ...
      [[nodiscard]] bool can_switch_to_optimality_phase(const Iterate& current_iterate, GlobalizationStrategy& globalization_strategy,
