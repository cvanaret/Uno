...
namespace uno {
   ...
   void LPSubproblem::solve_subproblem(Statistics& /*statistics*/, const OptimizationProblem& problem, Iterate& current_iterate,  const Multipliers& current_multipliers,
