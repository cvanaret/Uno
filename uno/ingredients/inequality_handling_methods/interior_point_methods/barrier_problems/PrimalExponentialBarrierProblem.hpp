...
#ifndef UNO_PRIMALEXPONENTIALBARRIERPROBLEM_H
#define UNO_PRIMALEXPONENTIALBARRIERPROBLEM_H
...
namespace uno {
   class PrimalExponentialBarrierProblem : public BarrierProblem {
   public:
      PrimalExponentialBarrierProblem(const OptimizationProblem& problem, double barrier_parameter,
...
#endif // UNO_PRIMALEXPONENTIALBARRIERPROBLEM_H