...
protected:
   ...
   static void generate_elastic_variables(const Model& model, ElasticVariables& elastic_variables, size_t number_variables);
...
inline l1RelaxedProblem::l1RelaxedProblem(const Model& model, double objective_multiplier,
   ...
   l1RelaxedProblem::generate_elastic_variables(this->model, this->elastic_variables, this->model.number_variables);
...
inline void l1RelaxedProblem::generate_elastic_variables(const Model& model, ElasticVariables& elastic_variables, size_t number_variables) {
