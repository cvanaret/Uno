...
namespace uno {
   void GlobalizationMechanism::assemble_trial_iterate(const Model& model, Iterate& current_iterate, Iterate& trial_iterate, const Direction& direction,
      ...
      /*
      trial_iterate.feasibility_multipliers.constraints.resize(current_iterate.feasibility_multipliers.constraints.size());
      trial_iterate.feasibility_multipliers.lower_bounds.resize(current_iterate.feasibility_multipliers.lower_bounds.size());
      trial_iterate.feasibility_multipliers.upper_bounds.resize(current_iterate.feasibility_multipliers.upper_bounds.size());
      */
