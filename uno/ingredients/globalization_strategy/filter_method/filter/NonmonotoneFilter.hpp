...
public:
   ...
   void add(double infeasibility_measure, double objective_measure) override;
...
protected:
   ...
   size_t compute_number_dominated_entries(double infeasibility_measure, double objective_measure);
};
