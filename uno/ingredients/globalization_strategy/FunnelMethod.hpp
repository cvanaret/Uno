...
namespace uno {
   ...
   public:
      ...
      [[nodiscard]] bool is_infeasibility_acceptable_to_funnel(double infeasibility_measure) const;
      [[nodiscard]] bool funnel_sufficient_decrease_condition(double infeasibility_measure) const;
   ...
   protected:
      double funnel_width{INF<double>};
