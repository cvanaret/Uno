...
std::unique_ptr<Subproblem> SubproblemFactory::create(size_t max_number_variables, size_t max_number_constraints,
   ...
   // interior-point method
      ...
      return std::make_unique<PrimalDualInteriorPointSubproblem>(max_number_variables, max_number_constraints,
