...
public:
   ...
   virtual Direction compute_second_order_correction(const NonlinearProblem& model, Iterate& trial_iterate);
   ...
   virtual void postprocess_accepted_iterate(const NonlinearProblem& model, Iterate& iterate);
