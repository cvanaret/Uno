...
namespace uno {
   ...
   public:
      ...
      void generate_initial_iterate(Statistics& statistics, const Subproblem& subproblem, Iterate& initial_iterate,
         Evaluations& evaluations) override;
      void compute_least_squares_multipliers(Statistics& statistics, const Subproblem& subproblem, Iterate& iterate,
         Evaluations& evaluations, double multipliers_threshold) override;
