...
namespace uno {
   ...
   void MA57Solver::solve_indefinite_system(View<double> solution) {
      ...
      if (this->use_iterative_refinement) {
         MA57_linear_solve_with_iterative_refinement(&this->workspace.job, &this->workspace.n, &this->workspace.nnz,
            ...
            this->workspace.ifact.data(), &this->workspace.lifact, this->linear_system.rhs.data(), solution.data(),
         ...
         MA57_linear_solve(&this->workspace.job, &this->workspace.n, this->workspace.fact.data(), &this->workspace.lfact,
            this->workspace.ifact.data(), &this->workspace.lifact, &nrhs, solution.data(), &lrhs,
