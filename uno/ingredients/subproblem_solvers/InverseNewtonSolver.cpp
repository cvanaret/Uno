...
namespace uno {
   ...
   void InverseNewtonSolver::generate_initial_iterate(Statistics& /*statistics*/, const Subproblem& /*subproblem*/,
         Iterate& /*initial_iterate*/, Evaluations& /*evaluations*/) {
      // do nothing
   }

   void InverseNewtonSolver::compute_least_squares_multipliers(Statistics& /*statistics*/, const Subproblem& /*subproblem*/,
