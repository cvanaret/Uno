...
namespace uno {
   ...
   void HiGHSQuadraticProgram::fill(Statistics& statistics, const Subproblem& subproblem, double trust_region_radius,
      ...
      if (warmstart_information.constraint_bounds_changed || warmstart_information.new_iterate) {
         subproblem.set_constraints_bounds(this->model.lp_.row_lower_, this->model.lp_.row_upper_,
            this->constraints);
      }
   }
   ...
   void HiGHSQuadraticProgram::compute_hessian_sparsity(const Subproblem& subproblem) {
