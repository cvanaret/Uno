...
namespace uno {
   ...
   void QuasiNewtonHessian::compute_candidate_pair(const Iterate& current_iterate, const Iterate& trial_iterate,
      ...
      DEBUG3 << "> s: " << this->latest_s << '\n';
      DEBUG3 << "> y: " << this->latest_y << '\n';
   }
   ...
   void QuasiNewtonHessian::compute_latest_y(const Iterate& current_iterate, const Iterate& trial_iterate,
         Evaluations& current_evaluations, Evaluations& trial_evaluations) {
